...
import { addToCart } from '../redux/DollasignSlice';
           ...
           <div className="w-3/5 flex flex-col justify-center gap-12">
            <div>
                ...
                <div className="flex item-center gap-4 mt-3">
                    <p className="line-through text-2x1 font-base text-gray-500">
                    ₦{details.oldPrice}
                    </p>
            ...
            <div className="flex items-center gap-2 text-base">
               ...
               <p className="text-xs text-orange-500">(Customer review)</p>
            </div>
            ...
            <div className="flex gap-4">
                ...
                border p-3">
                    ...
                    <button onClick={()=>setBsaeQty(baseQty ==1 ? (baseQty=1) : baseQty - 1)} className="border h-5 font-normal 
                     justify-center px-2 hover:bg-gray-700 hover:text-white cursor-pointer 
                     duration-300 active:bg-black" >
                        -
                        </button>
                    <span>{baseQty}</span>
                    <button onClick={()=>setBsaeQty(baseQty + 1)} className="border h-5 font-normal 
                     justify-center px-2 hover:bg-gray-700 hover:text-white cursor-pointer 
                     duration-300 active:bg-black">
                        +
                        </button>
